...
$out = 'D:\go_work\simple-admin\store-console-frontend\sql\dbg_q3probe6.txt'
'' | Out-File $out -Encoding UTF8

$files = @(
  'D:\go_work\simple-admin\wanshop-api\internal\types\types.go',
  'D:\go_work\simple-admin\wanshop-api\internal\types\wanshop_types.go',
  'D:\go_work\simple-admin\wanshop-api\internal\types\trade_types.go'
)
foreach ($f in $files) {
...
$r = Select-String -Path 'D:\go_work\simple-admin\wanshop-api\internal\handler\routes.go' -Pattern 'coupon|freight|bill|withdraw|settings' -Encoding UTF8
