...
Get-Content 'D:\go_work\simple-admin\store-console-frontend\sql\merchant_finance.sql' -Raw -Encoding UTF8 |
...
docker exec mysql mysql -uroot -p123456 simple_admin -e "DESCRIBE fa_withdraw;" |
  Out-File 'D:\go_work\simple-admin\store-console-frontend\sql\dbg_withdraw.txt' -Encoding utf8
