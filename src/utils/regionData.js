// 中国省市区静态数据（常用省会及重点城市）
// 格式：{ name: '省份', cities: [{ name: '城市', districts: ['区县'] }] }
...
const regionData = [
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '漳州市', districts: ['芗城区', '龙文区', '龙海区', '长泰区', '漳浦县', '云霄县', '诏安县', '东山县', '南靖县', '平和县', '华安县'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '东莞市', districts: ['东城街道', '南城街道', '万江街道', '莞城街道', '石碣镇', '石龙镇', '茶山镇', '石排镇', '企石镇', '横沥镇', '桥头镇', '谢岗镇', '东坑镇', '常平镇', '寮步镇', '樟木头镇', '大朗镇', '黄江镇', '清溪镇', '塘厦镇', '凤岗镇', '大岭山镇', '长安镇', '虎门镇', '厚街镇', '沙田镇', '道滘镇', '洪梅镇', '麻涌镇', '望牛墩镇', '中堂镇', '高埗镇', '松山湖管委会'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '儋州市', districts: ['那大镇', '和庆镇', '南丰镇', '大成镇', '雅星镇', '兰洋镇', '光村镇', '木棠镇', '海头镇', '峨蔓镇', '王五镇', '白马井镇', '中和镇', '排浦镇', '东成镇', '新州镇'] },
      { name: '五指山市', districts: ['通什镇', '南圣镇', '毛阳镇', '番阳镇'] },
      { name: '琼海市', districts: ['嘉积镇', '万泉镇', '石壁镇', '中原镇', '博鳌镇'] },
      { name: '文昌市', districts: ['文城镇', '铺前镇', '锦山镇', '翁田镇'] },
      { name: '万宁市', districts: ['万城镇', '龙滚镇', '和乐镇', '后安镇'] },
      { name: '东方市', districts: ['八所镇', '东河镇', '大田镇', '感城镇'] }
    ]
  },
  {
    name: '河北省',
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '驻马店市', districts: ['驿城区', '西平县', '上蔡县', '平舆县', '正阳县', '确山县', '泌阳县', '汝南县', '遂平县', '新蔡县', '济源市'] }
    ]
  },
  {
    name: '湖北省',
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '永州市', districts: ['零陵区', '冷水滩区', '东安县', '双牌县', '道县', '江永县', '宁远县', '蓝山县', '新田县', '江华瑶族自治县', '祁阳市'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '南通市', districts: ['通州区', '崇川区', '海门区', '如东县', '启东市', '如皋市', '海安市'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '长白山保护开发区', districts: ['池北区', '池西区', '池南区'] }
    ]
  },
  {
    name: '辽宁省',
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '包头市', districts: ['东河区', '昆都仑区', '青山区', '石拐区', '九原区', '白云鄂博矿区', '固阳县', '土默特右旗', '达尔罕茂明安联合旗'] },
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '杨凌示范区', districts: ['杨陵街道', '李台街道', '大寨街道', '五泉镇', '揉谷镇'] }
    ]
  },
  {
    name: '四川省',
  ...
  },
  {
    ...
    cities: [
      ...
      { name: '自治区直辖县级行政区划', districts: ['石河子市', '阿拉尔市', '图木舒克市', '五家渠市', '北屯市', '铁门关市', '双河市', '可克达拉市', '昆玉市', '胡杨河市', '新星市'] }
    ]
  },
  {
    name: '云南省',
  ...
  },
  {
    ...
    cities: [
      {
        name: '杭州市',
        districts: ['上城区', '拱墅区', '西湖区', '滨江区', '萧山区', '余杭区', '富阳区', '临安区', '临平区', '钱塘区', '桐庐县', '淳安县', '建德市']
      },
