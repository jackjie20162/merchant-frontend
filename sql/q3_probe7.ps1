...
$out = 'D:\go_work\simple-admin\store-console-frontend\sql\dbg_q3probe7.txt'
'' | Out-File $out -Encoding UTF8

$hf = 'D:\go_work\simple-admin\wanshop-api\internal\handler\merchant_biz_handlers.go'
...
$lf = 'D:\go_work\simple-admin\wanshop-api\internal\logic\merchant\merchant_biz_logic.go'
$srcs = @($hf, $lf)
foreach ($f in $srcs) {
