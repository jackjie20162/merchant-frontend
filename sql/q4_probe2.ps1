...
$out = 'D:\go_work\simple-admin\store-console-frontend\sql\dbg_q4b.txt'
'' | Out-File $out -Encoding UTF8

Write-Output '===== withdraw schema' | Out-File $out -Append -Encoding UTF8
Get-Content 'D:\go_work\simple-admin\wanshop-rpc\ent\schema\withdraw.go' -Encoding UTF8 | Out-File $out -Append -Encoding UTF8

Write-Output '===== WithdrawApply logic' | Out-File $out -Append -Encoding UTF8
$lines = Get-Content 'D:\go_work\simple-admin\wanshop-api\internal\logic\merchant\merchant_biz_logic.go' -Encoding UTF8
