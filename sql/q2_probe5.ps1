$out = 'D:\go_work\simple-admin\merchant-frontend\sql\dbg_q2dirs.txt'
'' | Out-File -Encoding utf8 $out
Get-ChildItem D:\go_work\simple-admin\zzhshopR2-rpc\internal\logic -Directory | ForEach-Object {
    $todo = 0
